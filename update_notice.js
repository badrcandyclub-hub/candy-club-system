    ...
    const showUpdatePopup = () => {
        ...
        const popupHtml = `
            <div id="candy-update-popup" style="position: fixed; top: 0; left: 0; width: 100vw; height: 100vh; background: rgba(0,0,0,0.85); z-index: 999999; display: flex; align-items: center; justify-content: center; backdrop-filter: blur(10px); animation: fadeInPopup 0.4s ease; font-family: 'Tajawal', sans-serif;">
                <div style="background-color: #ffe4e1; background-image: repeating-linear-gradient(45deg, rgba(255,105,180,0.08) 0px, rgba(255,105,180,0.08) 20px, transparent 20px, transparent 40px), radial-gradient(at 0% 0%, rgba(233,30,99,0.15) 0%, transparent 60%), radial-gradient(at 100% 100%, rgba(156,39,176,0.15) 0%, transparent 60%); border-radius: 24px; padding: 25px 20px 20px; width: 92%; max-width: 520px; box-shadow: 0 30px 60px rgba(0,0,0,0.25); text-align: center; position: relative; border: 2px solid rgba(233,30,99,0.2); animation: popInUpdate 0.6s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;">
